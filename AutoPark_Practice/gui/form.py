...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.map2Layout = QtWidgets.QVBoxLayout()
        self.map2Layout.setContentsMargins(1, -1, 0, -1)
        self.map2Layout.setObjectName("map2Layout")
        self.verticalLayout.addLayout(self.map2Layout)
